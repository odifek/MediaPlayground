...
public final class Util {
    ...
    public static int getStreamTypeForAudioUsage(@C.AudioUsage int usage) {
        switch (usage) {
            ...
            default:
                return C.STREAM_TYPE_USE_DEFAULT;
        }
    }
    ...
    public static UUID getDrmUuid(String drmScheme) {
        switch (com.google.android.exoplayer2.util.Util.toLowerInvariant(drmScheme)) {
            case "widevine":
    ...
    public static int inferContentType(String fileName) {
        fileName = com.google.android.exoplayer2.util.Util.toLowerInvariant(fileName);
...
//        com.google.android.exoplayer2.util.Util.<RuntimeException>sneakyThrowInternal(t);
    }
        ...
        if (com.google.android.exoplayer2.util.Util.SDK_INT < 25 && display.getDisplayId() == Display.DEFAULT_DISPLAY) {
            ...
            if ("Sony".equals(com.google.android.exoplayer2.util.Util.MANUFACTURER) && com.google.android.exoplayer2.util.Util.MODEL.startsWith("BRAVIA")
                ...
                return new Point(3840, 2160);
                    ...
                    || ("philips".equals(com.google.android.exoplayer2.util.Util.toLowerInvariant(com.google.android.exoplayer2.util.Util.MANUFACTURER))
                    && (com.google.android.exoplayer2.util.Util.MODEL.startsWith("QM1")
                    || com.google.android.exoplayer2.util.Util.MODEL.equals("QV151E")
                    || com.google.android.exoplayer2.util.Util.MODEL.equals("TPM171E")))) {
